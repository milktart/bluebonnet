...
router.get('/:id', async (req, res) => {
  try {
    const { Transportation, Trip, TripCompanion, TravelCompanion, ItemCompanion } = require('../../../models');
    ...
    transData.canEdit = isItemOwner || canEditTrip;
    transData.canDelete = isItemOwner || canEditTrip;
