...
db.TripAttendee = require('./TripAttendee')(sequelize, Sequelize);
...
db.ItemTrip = require('./ItemTrip')(sequelize, Sequelize);
db.CompanionPermission = require('./CompanionPermission')(sequelize, Sequelize);
