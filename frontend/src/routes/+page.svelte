...
<main class="w-full">
  ...
  <div class="relative isolate px-6 pt-14 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl py-32 desktop:py-48 lg:py-56">
      <div class="text-center">
        ...
        <h1 class="text-4xl font-bold tracking-tight text-gray-900 desktop:text-6xl">
          Your Next Adventure
    ...
    <div class="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl desktop:top-[calc(100%-30rem)]" aria-hidden="true">
      <div class="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-blue-200 to-blue-400 opacity-30 desktop:left-[calc(50%+36rem)] desktop:w-[72.1875rem]" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
    </div>
  </div>

  <!-- Features Section -->
  <div id="features" class="py-24 desktop:py-32 bg-gray-50">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl text-center">
        <h2 class="text-base font-semibold leading-7 text-blue-600">Everything you need</h2>
        <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 desktop:text-4xl">
      ...
      <div class="mx-auto mt-16 max-w-2xl desktop:mt-20 lg:mt-24 lg:max-w-none">
  ...
  <div class="py-24 desktop:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 desktop:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-center">
        <div class="lg:pr-8 lg:pt-4">
          <div class="lg:max-w-lg">
            <h2 class="text-base font-semibold leading-7 text-blue-600">Comprehensive planning</h2>
            <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 desktop:text-4xl">Everything in one place</p>
            <p class="mt-6 text-lg leading-8 text-gray-600">
...
<footer class="bg-white border-t border-gray-200">
  <div class="mx-auto max-w-7xl px-6 py-12 desktop:flex desktop:items-center desktop:justify-between lg:px-8">
    <div class="flex justify-center space-x-2 desktop:order-2">
      <div class="w-6 h-6 bg-blue-600 rounded-md flex items-center justify-center">
        <svg class="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"/>
        </svg>
